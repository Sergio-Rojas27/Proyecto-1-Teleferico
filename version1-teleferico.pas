...
Repeat //repeat de las opciones del menu
	...
	clrscr;
			...
			case (option) of //case principal
				...
				If bolven>60 then // condicional que revisa la cantidad de boletos que se quieren comprar
				writeln('+-------------------------------------------------------------+');
				writeln('|--------------------------- ERROR ---------------------------|');
				...
				writeln('+-------------------------------------------------------------+');	
				until bolven<=60; //fin del repeat que revisa la cantidad de boletos
